...
def add_movie(list, name, year, rating=5):                                          #Definerer en funksjon med 4 parametere
    movie_list.append({"name": name,"year": year,"rating": rating})                 #Legger til nye dictionary-elementer ved hjelp av .append

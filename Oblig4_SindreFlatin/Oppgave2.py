...
#1.6)
 ...
 # -------------------------------------------------------------------------------------------------------------------------------------------------
                    ...
                    while player_input != "4" or chip_stack > 0:
                        # 1.2 A)
                        if player_score == 21:
                            print("--------------------------------")
                            print("Blackjack! You won.")
                            chip_stack = int(chip_stack + bet)
                            print(f"You now have {chip_stack} chips")
                            print("--------------------------------")
                            ...
                            if choice_input == "2":
                                print("Okey. Goodbye, and welcome back!")
                                exit()

                        #1.2 B,C,D)
                        else:
                            print("--------------------------------")
                            while True: #player_input != "4" and player_score <= 21:
                                if chip_stack < 0:
                                    print("You're out of chips, goodbye!")
                                    exit()
